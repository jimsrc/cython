...
silent only
cd ~/simulacion/cython/data_parsing/2D-array_Doub_i
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +1 cython_wrapper.pyx
badd +1 test.py
badd +1 c_code.c
...
silent! normal! zE
let s:l = 135 - ((23 * winheight(0) + 13) / 26)
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 72 - ((14 * winheight(0) + 27) / 54)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
72
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 71 - ((48 * winheight(0) + 27) / 54)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
71
