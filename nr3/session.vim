...
silent only
cd ~/simulacion/cython/data_parsing/nr3
...
badd +0 ~/simulacion/pla_stochastic/composite_turbulence/single_orbits/src/cython_wrapper.pyx
badd +0 makefile
badd +0 nr3.pxd
args setup.py
edit setup.py
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 37 - ((13 * winheight(0) + 9) / 19)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
37
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 22 - ((3 * winheight(0) + 10) / 20)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
22
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 80 - ((3 * winheight(0) + 20) / 40)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
80
